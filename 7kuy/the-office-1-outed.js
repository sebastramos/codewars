...
function outed(meet, boss){
	let coworkers = Object.keys(meet).length
  console.log(coworkers)
  for(let bossScore in meet) {
  	if(bossScore === boss) {
    	meet[boss] *= 2
    }
  }
  let score = Object.values(meet).reduce((a,b) => a + b, 0)
  console.log()
 	return score / coworkers <= 5 ? 'Get Out Now!' : 'Nice Work Champ!'
}

console.log(outed({"tim":0,
									 "jim":8,
                   "randy":7,
                   "sandy":7,
                   "andy":5,
